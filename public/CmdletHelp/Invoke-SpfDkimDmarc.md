...
Checks the SPF, DMARC, DKIM, Mta and DNSSEC configuration for the domains binsec.nl and ing.nl. The latter domain has multiple DKIM-records. The module tries to detect all of them.
